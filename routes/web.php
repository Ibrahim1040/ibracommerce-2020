...
| les routes sont chargées par RouteServiceProvider au sein d'un groupe qui
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('product-delete',['as'=>'product-delete','uses'=>'DashboardController@deleteProduct']);
    ...
    Route::post('category-delete',['as'=>'category-delete','uses'=>'DashboardController@deleteCategory']);
    Route::post('subcategory-delete',['as'=>'subcategory-delete','uses'=>'DashboardController@deleteSubCategory']);
    Route::post('subsubcategory-delete',['as'=>'subsubcategory-delete','uses'=>'DashboardController@deleteSubSubCategory']);
    ...
    Route::post('order-delete',['as'=>'order-delete','uses'=>'DashboardController@deleteOrder']);
    Route::post('update-shipping-status',['as'=>'update-shipping-status','uses'=>'DashboardController@updateShippingStatus']);
    Route::post('update-payment-status',['as'=>'update-payment-status','uses'=>'DashboardController@updatePaymentStatus']);

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            ...
                                            <input type="text" id="f-name" name="first_name" value="{{ $user->first_name }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="l-name">Nom</label>
                                            <input type="text" id="l-name" name="last_name" value="{{ $user->last_name }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="login-email">E-mail </label>
                                            <input id="login-email" type="email" name="email" value="{{ $user->email }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="login-email">Ajoutez votre photo</label>

                        ...
                        <div class="col-lg-6 col-md-8 col-sm-8 col-lg-offset-3 col-sm-offset-2">
                            ...
                            <form class="main-form full" action="{{ route('user-update-password') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="login-pass">Ancien Mot de Passe</label>
                                            <input id="login-pass" type="password" name="old_password" required >
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="login-pass">Introduisez votre nouveau mot de passe</label>
                                            <input id="login-pass" type="password" name="password" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="re-enter-pass">Re-introduisez votre nouveau mot de passe</label>
                                            <input id="re-enter-pass" type="password" name="password_confirmation" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">

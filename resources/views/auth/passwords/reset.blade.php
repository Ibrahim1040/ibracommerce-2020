                        ...
                        <div class="col-lg-6 col-md-8 col-sm-8 col-lg-offset-3 col-sm-offset-2">
                            <form class="main-form full" action="{{ route('password.request') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="input-box">
                                            <label for="re-enter-pass">Retaper le mot de passe</label>
                                            <input id="re-enter-pass" type="password" name="password_confirmation" required placeholder="Re-enter your Password">
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <button name="submit" type="submit" class="btn-color btn-block right-side">réinitialiser le mot de passe</button>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="new-account align-center mt-20"> <span>Vous avez déjà un compte.</span> <a class="link" title="Login" href="{{ route('login') }}">Connectez-vous ici</a> </div>
                                    </div>
                                </div>
                            </form>
                        </div>

...
<head>
    ...
    @if($meta_status == 1 )
        ...
        <meta property="og:image" content="{{ asset('assets/images/logo-1.jpg') }}" />
    @else
        @yield('meta')
    @endif
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="navbar-header" style="margin-top:10">
                                <a class="navbar-brand page-scroll" href="{{ route('home') }}"> <img alt="{{ $basic->title }}" src="{{ asset('assets/images/nouveau-logo-1.png') }}"> </a>
                            </div>
                        </div>
                                ...
                                @else
                                    <li>
                                       ...
                                       <a href="{{ route('login') }}" title="Login">
                                            ...
                                            <i class="fa fa-sign-in" style="color:#1e4a7a" aria-hidden="true"></i>
                                            <span class="hidden-xs"  style="color:#48b5e2">Login</span>
                                        </a>
                                       </h2>
                                    </li>
                                @endif
                    ...
                    <div class="row">
                        <div class="col-md-4 f-col">
                            <div class="footer-static-block"> <span class="opener plus"></span>
                                <div class="f-logo"> <a href="{{ route('home') }}" class=""> <img src="{{ asset('assets/images/nouveau-logo-21.png') }}" alt="MarketShop"> </a>
                                </div>
                ...
                <div class="footer-bottom">
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="text-align:left">
                            <div class="copy-right center-sm">
                                <a href="https://www.abcsalles.com/mentions-legales" target="_blank" >Mentions légales</a>
                                <a href="https://media.abcsalles.com/fichiers/1/legal/cgu-abcsalles.pdf" target="_blank"> | CGU </a>
                                <a href="https://media.abcsalles.com/fichiers/1/legal/cgv-abcsalles.pdf" target=" _blank"> | CGV </a>
                                <a href="https://eur-lex.europa.eu/legal-content/FR/TXT/HTML/?uri=CELEX:32016R0679" target=" _blank"> | RGPD </a>
                            </div>
                        </div>
                    </div>
                </div>

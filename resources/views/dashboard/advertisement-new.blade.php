                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#tab_1_1" class="bold" data-toggle="tab">PROPRE PUBLICITÉ</a>
                                    </li>
                                    <li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="tab_1_1">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"><strong style="text-transform: uppercase;">Taille publicitaire</strong></label>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"><strong style="text-transform: uppercase;">Titre publicitaire</strong></label>
                                            <div class="col-md-12">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"><strong style="text-transform: uppercase;">lien publicitaire</strong></label>
                                            <div class="col-md-12">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"><strong style="text-transform: uppercase;">Image publicitaire</strong></label>
                                            <div class="col-md-12">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="input-group input-large">
                                                        ...
                                                        <span class="input-group-addon btn default btn-file">
                                                                    <span class="fileinput-new bold uppercase"> <i class="fa fa-picture-o"></i> Sélectionnez l'image </span>
                                                                    <span class="fileinput-exists bold uppercase"> Changement </span>
                                                                    <input type="file" name="val1" required> </span>
                                                        <a href="javascript:;" class="input-group-addon btn red fileinput-exists bold uppercase" data-dismiss="fileinput"> Retirer </a>
                                                    </div>
                                                    <code class="bold">La taille de l'image doit être égale à la taille de l'annonce.</code>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button class="btn btn-primary btn-block btn-lg bold"><i class="fa fa-send"></i>AJOUTEZ UNE NOUVELLE ANNONCE</button>
                                            </div>
                                        </div>
                                        {!! Form::close() !!}
                                    ...
                                    <div class="tab-pane fade" id="tab_1_2">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12"><strong style="text-transform: uppercase;">Affichez le code</strong></label>
                                            <div class="col-md-12">

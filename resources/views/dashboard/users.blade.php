    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <!-- Permet d'afficher les utilisateurs dans le dashboard -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Suppression d'un utilisateur ! Êtes vous sûr ?</strong>
                </div>
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('user-delete') }}" class="form-inline">
                        ...
                        <button type="submit" class="btn btn-success"><i class="fa fa-send"></i> Oui, je suis sûr !</button>
                    </form>
                </div>

        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body pad">
                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-area-chart"></i> Statistiques du site</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body pad">
                                ...
                                <div class="col-lg-3 col-xs-6">
                                    ...
                                    <div class="small-box bg-blue-gradient">
                                        <div class="inner">
                                            ...
                                            <p>Total sous sous-catégories</p>
                                        </div>
                                        <div class="icon">
                                            <i class="fa fa-list"></i>
                                        </div>
                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-pie-chart"></i> Statistique commandes</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body pad">
                    ...
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-line-chart"></i> Les 20 dernières commandes</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body pad">

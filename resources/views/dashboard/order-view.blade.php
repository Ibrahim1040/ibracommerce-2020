        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-info-circle"></i> Commande détails</h3>
                    <!-- tools box -->
                                    ...
                                    <table class="table table-bordered custom-table">
                                        ...
                                        @foreach($orderItem as $con)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="base-price price-box"> <span class="price">{{ $con->qty }} x {{ $con->price }}  {{$basic->symbol}}</span> </div>
                                                </td>
                            ...
                            <div class="cart-total-table commun-table">
                                <div class="table-responsive">
                                    <table class="table table-bordered custom-table">
                                        <tbody>
                                        <tr>
                                            <td class="text-right" width="50%">Etat du paiement </td>
                                            <td class="text-left">
                                                <div class="price-box custom-table">
                                                    @if($order->payment_status == 0)
                                                        <!-- <span class="label label-warning"><i class="fa fa-spinner"></i> Non Payée</span> -->
                                                        <button type="button" class="btn btn-xs btn-danger bold uppercase payment_button"
                                                                data-toggle="modal" data-target="#paymentModal"
                                                                data-id="{{ $order->id }}">
                                                            <i class='fa fa-times'></i> Non payée
                                                        </button>
                                                    @else
                                                        <!-- <span class="label label-success"><i class="fa fa-check"></i> Payée</span> -->
                                                        <button type="button" class="btn btn-xs btn-success bold uppercase payment_button"
                                                                data-toggle="modal" data-target="#paymentModal"
                                                                data-id="{{ $order->id }}">
                                                            <i class='fa fa-times'></i>Payée
                                                        </button>
                                                    @endif
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="text-right" width="50%">Etat de la livraison</td>
                                            <td class="text-left">
                                                @if($order->payment_status == 0)
                                                ...
                                                @else
                                                    @if($order->shipping_status == 0)
                                                        <button type="button" class="btn btn-xs btn-danger bold uppercase shipping_button"
                                                                ...
                                                                data-id="{{ $order->id }}">
                                                            <i class='fa fa-times'></i> Non traitée
                                                        </button>
                                        ...
                                        <tr>
                                            <td class="text-right"><b>Etat de la commande</b></td>
                                            <td class="text-left">
                                                <div class="price-box">
                                                    @if($order->status == 1)
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered custom-table">
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="price-box"> <span class="price custom-table">{{ $order->subtotal }} {{ $basic->symbol }}</span> </div></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right">Tva 21 %</td>
                                            <td><div class="price-box"> <span class="price custom-table">{{ $order->tax }} {{ $basic->symbol }}</span> </div></td>
                                        </tr>
                                        <tr>
                                            <td class="text-right"><b>Montant total</b></td>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <p>{{ $userDetails->s_zip }} {{ $userDetails->s_city }} {{ $userDetails->s_state }} </p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title bold uppercase" id="myModalLabel"> <i class='fa fa-recycle'></i> Changez le statut du paiement!</h4>
                </div>

                <div class="modal-body">
                    <form id="frmProducts" action="{{ route('update-payment-status') }}" method="post" class="form-horizontal">
                        {!! csrf_field() !!}
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label bold uppercase">Changez le statut : </label>
                            <div class="col-sm-8">
                                <select class="form-control bold" name="status" required>
                                    <option value="" class="bold">Sélectionnez</option>
                                    <option value="0" class="bold">Non Payé<em></em></option>
                                    <option value="1" class="bold">Payé</option>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-lg-offset-3">
                                <button class="btn btn-primary btn-block bold uppercase" id="btn-save" value="add"><i class="fa fa-send"></i>État de mise à jour</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="shippingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title bold uppercase" id="myModalLabel"> <i class='fa fa-recycle'></i> Changez le statut de Livraison!</h4>
                </div>
                    ...
                    <form id="frmProducts" action="{{ route('update-shipping-status') }}" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control bold" name="status" required>
                                    <option value="" class="bold">Sélectionnez</option>
                                    <option value="0" class="bold">Non livrée</option>
                                    <option value="1" class="bold">En attente</option>
                                    <option value="3" class="bold">Livrée</option>
                                    <option value="2" class="bold">Annulée</option>
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title bold uppercase" id="myModalLabel"> <i class='fa fa-recycle'></i> Changez le statut !</h4>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control bold" name="status1" required>
                                    <option value="" class="bold">Sélectionnez</option>
                                    <option value="0" class="bold">En attente</option>
                                    <option value="1" class="bold">Confirmée</option>
                                </select>
                            </div>
                        </div> 

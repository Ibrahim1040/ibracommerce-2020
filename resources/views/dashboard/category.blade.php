        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <div class="box-title">
                        <button id="btn_add" name="btn_add" class="btn btn-primary bold"><i class="fa fa-plus"></i> Ajouter catégorie</button>
                    </div>
                    <!-- tools box -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title bold uppercase" id="myModalLabel"><i class="fa fa-indent"></i> Catégorie produit</h4>
                </div>
                <div class="modal-body">
                    <form id="frmProducts" name="frmProducts" class="form-horizontal" novalidate="">
                        <div class="form-group">
                            <label for="inputName" class="col-sm-3 control-label bold uppercase">Nom catégorie : </label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control has-error bold " id="name" name="name" placeholder="Nom Catégorie" value="">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('category-status') }}" class="form-inline">
                        ...
                        <button type="submit" class="btn btn-success"><i class="fa fa-send"></i> OUI.</button>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('category-delete') }}" class="form-inline">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Fermer</button>
                        <button type="submit" class="btn btn-success"><i class="fa fa-send"></i>Oui bien sûr.</button>
                    </form>
                </div>
        ...
        $("#btn-save").click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    product += '<td><button class="btn btn-primary btn-detail open_modal bold uppercase" value="' + data.id + '"><i class="fa fa-edit"></i> EDITER</button></td></tr>';
                ...
                toastr.success('Catégorie Sauvegardée.');
            });
        });
        $(function () {
            $('.select2').select2();

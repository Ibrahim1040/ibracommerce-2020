                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="heading-part align-center">
                                    <h2 class="heading">Sélectionnez un mode de paiement</h2>
                                    <h2 class="heading">Montant total : <span class="payment-balance">{{ $basic->symbol }}{{ $orderDetails->total }}</span></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-6 mb-20">
                                                    <div class="paypal-box">
                                                        ...
                                                        <a href="{{ route('payment-overview',['id'=>$pm->id,'orderNumber'=>$orderDetails->order_number]) }}" class="btn btn-color btn-block" style="border-radius: 3px;margin-top: 10px">Payez maintenant</a>
                                                    </div>
                                                </div>
                                                @endforeach
                                            </div>

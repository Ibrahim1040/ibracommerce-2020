                ...
                <div class="box-body pad">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Titre du site</strong></label>
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Couleur de base</strong></label>
                                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Monnaie libellé</strong></label>
                                    <div class="col-md-12">
                                        <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Symbole monnaie </strong></label>
                                    <div class="col-md-12">
                                        <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">TVA</strong></label>
                                    <div class="col-md-12">
                                        <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">E-mail</strong></label>
                                    <div class="col-md-12">
                                        <div class="input-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Commade en attente supposée expirée aprés </strong></label>
                                    <div class="col-md-12">
                                        <div class="input-group">
                            ...
                            <!-- fin de commande en attente -->
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-12"><strong style="text-transform: uppercase;">Meta Tag</strong></label>
                                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary btn-block btn-lg"><i class="fa fa-send"></i> Enregistrer</button>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}

...
class WebSettingController extends Controller
{
    ...
    {
        $data['page_title'] = "Gestion Logo & Favicon";
    ...
    public function updateLogo(Request $request)
    {
        ...
        session()->flash('message','Logo et Favicon a été mis à jour avec succès.');
    ...
    {
        $data['page_title'] = "Gestion bas de page";
    ...
    public function updateFooter(Request $request,$id)
    {
        ...
        $basic->fill($in)->save();
        session()->flash('message','Pied de page Web mis à jour avec succès.');
        session()->flash('title','Success');
        session()->flash('type','success');
        return redirect()->back();
    }
    ...
    {
        $data['page_title'] = "Gestion des sliders";
    ...
    public function storeSlider(Request $request)
    {
        ...
        Slider::create($in);
        session()->flash('message','Le slider a été créé avec succès.');
        session()->flash('title','Success');
        session()->flash('type','success');
        return redirect()->back();
    }
    public function deleteSlider(Request $request)
    {
        ...
        session()->flash('message','Slider supprimé avec succès.');
        session()->flash('title','Success');
        session()->flash('type','success');
        return redirect()->back();
    }
    ...
    {
        $data['page_title'] = "Gestion des réseaux sociaux";
    ...
    public function updateMenu(Request $request,$id)
    {
        ...
        session()->flash('message', 'Menu mis à jour avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    {
        $data['page_title'] = "Gestion Breadcrumb";
    ...
    public function updateBreadcrumb(Request $request)
    {
        ...
        $basic->fill($in)->save();
        session()->flash('message', 'Fil d\'Ariane mis à jour avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updateParallax(Request $request)
    {
        ...
        $basic->fill($in)->save();
        session()->flash('message', 'Image de parallaxe mise à jour avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updateAbout(Request $request)
    {
        ...
        $basic->save();
        session()->flash('message', 'Mise à jour a propos réussie.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updatePrivacyPolicy(Request $request)
    {
        ...
        $basic->save();
        session()->flash('message', 'Politique de confidentialité mise à jour avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    {
        $data['page_title'] = "Termess Conditions ";
    ...
    public function updateTermsCondition(Request $request)
    {
        ...
        $basic->save();
        session()->flash('message', 'Termes et conditions mises à jour avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function storeFaqs(Request $request)
    {
        ...
        $in = Input::except('_method','_token');
        Faqs::create($in);
        session()->flash('message', 'FAQS créée avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updateFaqs(Request $request, $id)
    {
        ...
        $in = Input::except('_method','_token');
        $faqs->fill($in)->save();
        session()->flash('message', 'FAQS mise à jour avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function deleteFaqs(Request $request)
    {
        ...
        session()->flash('message', 'FAQS supprimée avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updateTestimonial(Request $request,$id)
    {
        ...
        session()->flash('message', 'Mise à jour du témoignage réussie.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updatePartner(Request $request,$id)
    {
        ...
        $testimonial->fill($in)->save();
        session()->flash('message', 'Mise à jour du partenaire réussie.');
        Session::flash('type', 'success');
        Session::flash('title', 'Success');
        return redirect()->back();
    }
    ...
    public function updateAboutText(Request $request)
    {
        ...
        $in = Input::except('_method','_token');
        $page->fill($in)->save();
        session()->flash('message','À propos de la mise à jour du texte réussie.');
        session()->flash('title','Success');
        session()->flash('type','success');
        return redirect()->back();
    }
    ...
    public function updateSpeciality(Request $request)
    {
        ...
        session()->flash('message','Mise à jour de spécialité réussie.');
        session()->flash('type','success');
        return redirect()->back();
    }
    ...
    public function updateSpecialityBg(Request $request)
    {
        ...
        session()->flash('message','Mise à jour de la spécialité Bg réussie.');
        session()->flash('type','success');
        return redirect()->back();
